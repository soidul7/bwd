 ...
 <NavBar/>
  <!-- banner start here -->
     ...
     <div class="banner-content banner-content-about">
      <div class="hero-text">
        <h2><strong>Our Portfolio</strong></h2>
...
.blogTab .card-item .card-item-image  {
    position: relative;
    box-shadow: 0px 4px 25px rgba(0, 0, 0, 0.08);
    border-radius: 10px;
    transition: all ease-in-out 300ms;
}
.blogTab .card-item .card-item-image:hover::after  {
    opacity: 1;
    transition: all ease-in-out 300ms;
}
.blogTab .card-item .card-item-image img{
    width: 100%;
    border-radius: 10px;
    display: block;
    transition: all ease-in-out 300ms;
}
.blogTab .card-item .card-item-image::after  {
    content: "";
    width: 100%;
    height: 100%;
    top: 0;
...
.blogTab .card-item .card-item-image .card-item-image-btn  {
    position: absolute;
    top: 50%;
    left: 50%;
...
.blogTab .card-item .card-item-image .card-item-image-btn a  {
    text-decoration: none;
    background: #fff;
    font-weight: 500;
    font-size: 14px;
...
.blogTab .card-item .card-item-image:hover .card-item-image-btn  {
    opacity: 1;
}
.blogTab .card-item .card-item-image .card-item-image-btn a span  {
    padding-right: 5px;
}
...
.blogTab .card-item .atle-text h2 {
    font-weight: 600;
    font-size: 21px;
    line-height: 32px;
    color: #000000;
}
.blogTab .card-item .atle-text p {
    font-weight: 400;
    font-size: 16px;
    line-height: 25px;
    color: #353535;
