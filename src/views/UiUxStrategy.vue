...
<MetaTag :title="metaTitle" :description="metaDescription"/>   
  ...
  <body>
     <!-- banner start here -->
     <Banner title="UI/UX Design" description="Increase Your ROI And Put Your Brand To The Forefront" />
     <!-- banner end -->
     ...
     <div class="personal-success">
        <div class="heading-title">
          <h2>If you&#39;re looking for a design partner,  <strong>look no further</strong></h2> 
        </div>
          ...
          <div class="container">
            <div class="row gy-10 vr__column__line">
              ...
              <div class="col-lg-6 col-md-6 column-no-odd">
                <div class="item-img">
                  <img src="@/assets/images/YourSuccess/uiux-distinguish-between-ui.png" alt="" class="fistImg">
                </div>
              </div>
              <div class="col-lg-6 col-md-6 column-no-even">
                <div class="item-card">
                  <div class="card">
                    <h4>01. Distinguish between UI/UX</h4>
                    <p class="mb-1">The User Interface (UI) is the visual design and layout of a product, as well as its content,
                      iconography, and other elements. UI designers&#39; job is to create a user-friendly interface that will
                      assist people in solving difficulties.</p>
                      <p>The UX encompasses a lot more than the UI. The goal of UX design is to create meaningful
                        experiences, which includes the user interface as well. It entails interactive design, wireframing,
              ...
              <div class="col-lg-6 col-md-6 column-no-odd">
                <div class="item-card">
                  <div class="card">
                    <h4>02. What is the importance of UX in your company?</h4>
                    <p>The goal of good UX is to cater the service or perform the function as quickly as feasible. Poor
                      UX leads to a higher desertion rate, as evidenced by the data. Customers are considerably more
                      likely to stick around and make a purchase if the user experience is intuitive and the number of
                      stages is kept to a minimum.</p>
                  </div>
                  <div class="line__active">
                    <span></span>
                  </div>
              ...
              <div class="col-lg-6 col-md-6 column-no-even">
                <div class="item-img">
                  <img src="@/assets/images/YourSuccess/uiux-what-is-the-importance-of.png" alt="">
                </div>
              </div>
              <div class="col-lg-6 col-md-6 column-no-odd">
                <div class="item-img">
                  <img src="@/assets/images/YourSuccess/uiux-the-role-of-ux-design-in.png" alt="">
                </div>
              </div>
              <div class="col-lg-6 col-md-6 column-no-even">
                <div class="item-card">
                  <div class="card">
                    <h4>03. The role of UX design in development is critical</h4>
                    <p>Ultimately, the success of any platform, website, or app is determined by how users react to it:
                      does it suit their requirements and mitigate their issues? When you incorporate a user experience emphasis into your product design and development process, you&#39;ll end up with a product that&#39;s
                      not only functional, but also useful, practical, and even enjoyable to use.</p>
                  </div>
                  <div class="line__active">
                    <span></span>
                  </div>
              ...
              <div class="col-lg-6 col-md-6 column-no-odd">
                <div class="item-card">
                  <div class="card">
                    ...
                    <p>We thrill our <strong>CLIENTS</strong> by designing software systems such as online portals and mobile
                      applications that are user-friendly, innovative, and ready for development. A good design is a
                      good investment since it decreases the chances of making mistakes and overpaying.</p>
                  </div>
                  <div class="line__active">
                    <span></span>
                  </div>
              ...
              <div class="col-lg-6 col-md-6 column-no-even">
                <div class="item-img">
                  <img src="@/assets/images/YourSuccess/uiux-what-can-we-offer.png" alt="">
                </div>
              </div>
