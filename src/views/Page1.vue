          ...
          <div class="col-lg-8">
            <div class="content">
              ...
              <!-- <div class="item" style="margin-top:20px;">
                <div class="card-box ">
                  <h3>Summary</h3>
                  <p><img src="frontend/images/icon/“ (1).svg" alt="" class="img-ful"> {{details.data[0].summary}}</p>
                </div>
              </div> -->
            </div>
          </div>
...
.blog-dtl-sect .content .item span p span {
    font-weight: 400;
    font-size: 16px;
    color: #6C6C6D;
    line-height: 22px;
...
/* .blog-dtl-sect .content .item span p span strong {
