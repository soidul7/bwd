       ...
       <div class="container meet-cart-align">
         <div class="meet-cart">
           ...
           <div class="row">
            ...
            <div class="col-lg-5">
              <div class="cntct-btn">
                <a href="tel:+1 678 608 2725" class="btn"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-telephone-fill" viewBox="0 0 16 16">
