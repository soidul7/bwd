...
$sql = "INSERT INTO `get_in_touch` (name, email, number, message, createdDate)
...
$ADMIN_NAME = 'Reddensoft Infotect PVT & LTD';
$TO_NAME = $NAME;
...
<html>
  <head>
    <title>Contact Us, Chris Callaway</title>
  </head>
  <body>
    <p><b>Contact Us, Chris Callaway</b></p>
    <br>
...
<html>
  ...
  <body>
    ...
    <br>
    <p>Thanks you</p>
    <p>Reddensoft Infotect PVT & LTD</p>
  </body>
</html>
";

foreach($ADMIN_EMAIL_ARRAY as $key=>$ADMIN_TO_EMAIL ){
  $resultAdminEmail = send_email($ADMIN_EMAIL,$ADMIN_NAME,$ADMIN_TO_EMAIL,$ADMIN_NAME,'Contact Us, Chris Callaway',$MESSAGES_ADMIN);
} 
if($resultAdminEmail){
