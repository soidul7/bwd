...
$sql = "INSERT INTO `stay_connected_with` (name, email, phone, subject, createdDate)
VALUES ('".$NAME."', '".$TO_EMAIL."', '".$PHONE."','".$CONTENT."', '".date("Y-m-d H:i:s")."')";
...
<html>
  <head>
    <title>Stay <strong> Connected</strong> With Us</title>
  </head>
  <body>
    <p><b>Stay <strong> Connected</strong> With Us</b></p>
    <br>
    <p><b>Name: </b>".$TO_NAME."</p>
...
foreach($ADMIN_EMAIL_ARRAY as $key => $ADMIN_TO_EMAIL ){
  $resultAdminEmail = send_email($ADMIN_EMAIL,$ADMIN_NAME,$ADMIN_TO_EMAIL,$ADMIN_NAME,'Stay Connected With Us',$MESSAGES_ADMIN);
} 
if($resultAdminEmail){
// $headers .= 'Cc: myboss@example.com' . "\r\n";
//if(send_email($ADMIN_EMAIL,$ADMIN_NAME,$ADMIN_EMAIL,$ADMIN_NAME,'Stay Connected With Us',$MESSAGES_ADMIN)){
...
//send_email($ADMIN_EMAIL,$ADMIN_NAME,$TO_EMAIL,$TO_NAME,'Stay Connected With Us',$MESSAGES_ADMIN);
